...
namespace ShaderLib.Bones
{
    public class BoneController : MonoBehaviour
    {
        ...
        public List<BoneColliderBase> m_Colliders = null;
        ...
        List<Params> m_Params = new List<Params>();

        private void Start()
        {
            if (this.m_Colliders == null || this.m_Colliders.Count <= 0) {
                this.m_Colliders = GetComponentsInChildren<BoneColliderBase>().ToList();
            }
            SetupParticles();
        }
            ...
            for (int i = 1; i < m_Particles.Count; ++i) {
                ...
                if (m_Colliders != null) {
                    ...
                    for (int j = 0; j < m_Colliders.Count; ++j) {
                        BoneColliderBase c = m_Colliders[j];
                        if (c != null && c.enabled) {

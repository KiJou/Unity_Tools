#ifndef IMPOSTERCOMMON_CGINC
#define IMPOSTERCOMMON_CGINC
...
void ImposterVertex(inout appData imp )
{
...
void ImposterSample( in appData imp, out half4 baseTex, out half4 worldNormal )
{

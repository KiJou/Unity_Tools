...
Shader "UnityChanToonShader/Toon_ShadingGradeMap_Hatch" 
{
    Properties 
    {
        [HideInInspector] _simpleUI ("SimpleUI", Int ) = 0
        [HideInInspector] _utsVersion ("Version", Float ) = 2.07
        [HideInInspector] _utsTechnique ("Technique", int ) = 1
        ...
        [Header(Hatch)]
		_HatchSheet("Hatch Sheet", 2D) = "white" {}
		_HatchBlend("Hatch Blend", Range(0, 1)) = 0
		_ColX("ColX", int) = 1
		_RowY("RowY", int) = 8
		_AnimationSpeed("AnimationSpeed", Float) = 10

        //_Hatch0("Hatch 0", 2D) = "white" {}
        //_Hatch1("Hatch 1", 2D) = "white" {}
        //_HatchOffset("Hatch Offset", float) = 8
        //_XShift("X Shift", Range(-1.0, 1.0)) = 0
        //_XSpeed("X Scroll Speed", Range(1.0, 100.0)) = 10.0
        //_YShift("Y Shift", Range(-1.0, 1.0)) = 0
        //_YSpeed("Y Scroll Speed", Range(1.0, 100.0)) = 10.0
        //_Amplitude("Amplitude", Range(0, 0.01)) = 0
        //_AmplitudeSpeed("AmplitudeSpeed", Range(0, 10)) = 1
    ...
    SubShader 
    {
        Pass {
            ...
            //#pragma multi_compile _IS_PASS_HATCH
        ...
        Pass {
            ...
            #pragma target 3.0
            #pragma multi_compile _IS_PASS_HATCH
            #include "UCTS_CustomBlendMode.cginc"
            ENDCG
        }

...
Shader "UnityChanToonShader/Toon_ShadingGradeMap_Custom" 
{
    Properties 
    {
        ...
        [KeywordEnum(SIMPLE,ANIMATION, PINGPONG)] _EMISSIVE("EMISSIVE MODE", Float) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            //#pragma multi_compile_fog
            #pragma target 3.0
            #pragma multi_compile _EMISSIVE_SIMPLE _EMISSIVE_ANIMATION _EMISSIVE_PINGPONG

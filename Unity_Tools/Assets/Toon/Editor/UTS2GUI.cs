...
namespace UnityChan
{
    public class UTS2GUI : ShaderGUI
    {
        ...
        {
            SimpleEmissive, EmissiveAnimation, PingpongAnimation,
        }
        ...
        MaterialProperty blendWeight = null;
        ...
        MaterialProperty blurMap = null;
        MaterialProperty blurMapColor = null;
        MaterialProperty blurPower = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            blendWeight = FindProperty("_BlendWeight", props);
            ...
            blurMap = FindProperty("_BlurMap", props, false);
            blurMapColor = FindProperty("_BlurMapColor", props, false);
            blurPower = FindProperty("_BlurPower", props, false);
            ...
            emissive_Tex = FindProperty("_Emissive_Tex", props, false);
            emissive_Color = FindProperty("_Emissive_Color", props, false);
            base_Speed = FindProperty("_Base_Speed", props, false);
            scroll_EmissiveU = FindProperty("_Scroll_EmissiveU", props, false);
            scroll_EmissiveV = FindProperty("_Scroll_EmissiveV", props, false);
            rotate_EmissiveUV = FindProperty("_Rotate_EmissiveUV", props, false);
            colorShift = FindProperty("_ColorShift", props, false);
            colorShift_Speed = FindProperty("_ColorShift_Speed", props, false);
            viewShift = FindProperty("_ViewShift", props, false);
        ...
        private static class Styles
        {
            ...
            public static GUIContent blendColorText = new GUIContent("BlendMap", "Base Color : Texture(sRGB) × Color(RGB) Default:White");
            public static GUIContent blurColorText = new GUIContent("Blur ShadeMap", "Blur ShadeColor : Texture(sRGB) × Color(RGB) Default:White");
        ...
        void GUI_BasicThreeColors(Material material)
        {
            ...
            m_MaterialEditor.TexturePropertySingleLine(Styles.blendColorText, blendTex, blendWeight);
            EditorGUILayout.Space();

            if (blurPower != null)
            {
                EditorGUILayout.BeginHorizontal();
                m_MaterialEditor.RangeProperty(blurPower, "BlurPower");
                EditorGUILayout.EndHorizontal();
                EditorGUILayout.Space();
            }
            ...
            if (_NormalMap_Foldout)
            {
                ...
                //GUILayout.Space(60);
                if (material.HasProperty("_Is_NormalMapToHighColor"))
                {
        ...
        void GUI_Emissive(Material material)
        {
            ...
            else if ((int)_EmissiveMode.PingpongAnimation == _EmissiveMode_Setting)
            {
                emissiveMode = _EmissiveMode.PingpongAnimation;
            }
            EditorGUILayout.Space();
            EditorGUILayout.BeginHorizontal();
            ...
            if (emissiveMode == _EmissiveMode.SimpleEmissive)
            {
                if (GUILayout.Button("Off", shortButtonStyle))
                {
                    ...
                    material.DisableKeyword("_EMISSIVE_PINGPONG");
                }
            }
            else if (emissiveMode == _EmissiveMode.EmissiveAnimation)
            {
                if (GUILayout.Button("Animation", shortButtonStyle))
                {
                    material.SetFloat("_EMISSIVE", 2);
                    material.EnableKeyword("_EMISSIVE_PINGPONG");
                    material.DisableKeyword("_EMISSIVE_ANIMATION");
                    material.DisableKeyword("_EMISSIVE_SIMPLE");
                }
            }
            else if (emissiveMode == _EmissiveMode.PingpongAnimation)
            {
                if (GUILayout.Button("Pingpong", shortButtonStyle))
                {
            ...
            // pingpong
            if (emissiveMode == _EmissiveMode.PingpongAnimation)
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.BeginHorizontal();
                m_MaterialEditor.FloatProperty(base_Speed, "Base Speed (Time)");
